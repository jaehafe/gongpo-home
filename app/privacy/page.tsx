...
export const metadata: Metadata = {
  title: "Privacy Policy - Gongpo",
  description: "Gongpo Privacy Policy",
};
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <article className="prose prose-neutral dark:prose-invert max-w-none">
          ...
          <p className="text-muted-foreground mb-8">
            This privacy policy applies to the Gongpo app (hereby referred to as
            &quot;Application&quot;) for mobile devices that was created by
            Mapletask (hereby referred to as &quot;Service Provider&quot;) as a
          ...
          <Section title="Information Collection and Use">
            ...
            <p>
              ...
              address, display name, profile picture (optional). The information
              that the Service Provider request will be retained by them and
          ...
          <Section title="Data Storage">
            <p>
              Your documents and notes are primarily stored locally on your
              device. This means your data remains on your device and is
              accessible even without an internet connection. When you enable
              cloud synchronization, your data is securely synced to our servers
              to enable access across multiple devices and real-time
